...
\begin{tightList}[\setlength{\labelwidth}{0em}]
  ...
  \item[\textbf{epoch}] current epoch vector (see section \ref{sec:epoch_ss})%TODO: ref on epochss
\end{tightList}

\strut

The \texttt{Storage} implementation must be chosen according to the Recovery Model needs. % TODO: ref on recovery model needs
