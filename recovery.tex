...
\begin{table}[h]
  ...
  \begin{tabular}{l|ccccc}
                        & Crash-stop & Full stable storage & View based      & Epoch based \\ \hline
    Always correct      & majority   & 0                   & majority        & majority \\
    Process can recover & no         & yes                 & yes             & yes \\
    Stable storage use  & no         & per round           & per view change & on recovery \\
    Additional messages & no         & no                  & \recovery       & \recovery \\
    State transfer      & no         & no                  & yes             & yes \\
    Increased msg size  & no         & no                  & no              & \prepareOK ($n$)\\ \hline
  \end{tabular}
